...
// @downloadURL  https://github.com/lufurt/FinanceTool-Translated/raw/main/finance-tools.user.js
// @updateURL    https://github.com/lufurt/FinanceTool-Translated/raw/main/finance-tools.user.js
// ==/UserScript==
    ...
    const options = {
        tooltip: {
            ...
            formatter: (params) => {
                ...
                const tooltip = [];
                if (projection) tooltip.push(`<div style="font-size: 11px; font-weight: bold;">Projection!<br/>(Based in average data)</div>`);
